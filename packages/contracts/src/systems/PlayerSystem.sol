...
import { Direction, Action } from "../codegen/Types.sol";
...
contract PlayerSystem is System {
  ...
  function attack(Action action) public {
    require(action != Action.Unknown, "invalid action");
